        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24 text-center">
          ...
          <div className="flex justify-center mb-12">
            {categories.map((category, index) => (
              <button
                key={index}
                className={`px-4 py-2 mx-2 rounded-full text-lg transition-colors ${
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {filteredData.map((project, index) => (
              ...
              >
                ...
                <div
                  className={`absolute inset-0 flex flex-col justify-center items-center bg-opacity-80 bg-black text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300 ${
                    project.image ? "" : "opacity-100"
                  }`}
                >
