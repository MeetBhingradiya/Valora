  ...
  return (
    <nav
      ...
      className={`fixed w-full top-0 z-50 transition-all duration-500 ${
        State.isScrolled ? "bg-secondary text-white" : "bg-secondary text-white"
      }`}
    >
        ...
        >
          <div
            className={`h-0.5 w-full bg-primary transition-all duration-300 ${
              State.isMenuOpen ? "rotate-45 translate-y-2.5" : ""
            }`}
          ></div>
          <div
            className={`h-0.5 w-full bg-primary transition-all duration-300 ${
              State.isMenuOpen ? "opacity-0" : "opacity-100"
            }`}
          ></div>
          <div
            className={`h-0.5 w-full bg-primary transition-all duration-300 ${
        ...
        <ul className="hidden md:flex space-x-8 text-base">
            ...
            >
              ...
              <FaChevronDown
                className={`ml-1 transition-transform duration-300 ${
                  State.isServicesOpen ? "rotate-180" : "rotate-0"
                }`}
              />
            </button>
          ...
          >
            ...
            >
              ...
              <FaChevronDown
                className={`ml-1 transition-transform duration-300 ${
                  State.isToolsOpen ? "rotate-180" : "rotate-0"
                }`}
              />
            </button>
            {State.isToolsOpen && (
            ...
            >
              ...
              <FaChevronDown
                className={` transition-transform duration-300 ${
                  State.isMobileServicesOpen ? "rotate-180" : "rotate-0"
                }`}
              />
            </button>
