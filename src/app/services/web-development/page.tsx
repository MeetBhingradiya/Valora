        ...
        */}
        ...
        <div className="mb-12">
          ...
          {[
            ...
            <div key={item.title} className={`mb-12 p-4 md:p-6 rounded-3xl shadow-lg bg-gradient-to-r ${index % 2 === 0 ? 'from-primary to-[#f1f0f0]' : 'from-[#f1f0f0] to-primary'} bg-opacity-50`}>
